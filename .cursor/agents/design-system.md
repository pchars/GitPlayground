---
name: design-system
description: "GitPlayground design specification — tokens, typography, components. Read DESIGN.md at repo root (not a workflow agent)."
...
**[`DESIGN.md`](../../DESIGN.md)** at the repository root — the single source of truth
...
migration policy). Always read the full `DESIGN.md` before visual changes.
