...
SOLUTIONS: dict[str, list[str]] = {
    ...
    "sandbox_cat": ["cat practice/notes.txt"],
    "sandbox_echo_append": ["echo sandbox >> practice/notes.txt"],
    "sandbox_type_empty": ["type nul > practice/blank.txt"],
    "sandbox_head": ["head -n 1 practice/notes.txt"],
    "sandbox_tail": ["tail -n 1 practice/notes.txt"],
    "sandbox_wc": ["wc -l practice/notes.txt"],
    "sandbox_cp": ["cp practice/notes.txt practice/copy.txt"],
    "sandbox_mv": ["mv practice/copy.txt practice/backup.txt"],
    "sandbox_find": ["find practice"],
    "sandbox_rm": ["rm practice/blank.txt"],
    "sandbox_nano": ["nano practice/diary.txt"],
    "sandbox_clear": ["clear"],
    "sandbox_touch": ["touch practice/notes.txt"],
    "sandbox_echo_write": ["echo GitPlayground > practice/notes.txt"],
